...
function SubcategoryTierTwoItem(props) {
    ...
    const deleteSubcategory = (event) => {
        ...
        axios.get('api/users/csrf/token', {})
            .then((response) => {
                axios.delete(`api/products/subcategory_tier_two/delete/${props.subcategoryTierTwo.id}`, {
                    headers: {
        ...
        <SubcategoryItemContainer key={props.id}>
            ...
            <MetricsContainer>
                <Typography variant="body2" sx={{margin: '0', overflow: 'hidden', textWrap: 'nowrap'}}>
                    <b>Id: </b>{props.subcategoryTierTwo.id}
                </Typography>
                <Typography variant="body2" sx={{margin: '0', overflow: 'hidden', textWrap: 'nowrap'}}>
                    <b>Name: </b>{props.subcategoryTierTwo.name}
                </Typography>
                <Typography variant="body2" sx={{margin: '0', overflow: 'hidden', textWrap: 'nowrap'}}>
                    <b>Subcategory: </b>{props.subcategoryTierTwo.subcategory.name}
                </Typography>
                <Typography variant="body2" sx={{margin: '0', overflow: 'hidden', textWrap: 'nowrap'}}>
                    <b>Category: </b>{props.subcategoryTierTwo.subcategory.category.name}
                </Typography>
            </MetricsContainer>
            ...
            <ButtonsContainer>
                <EditButton
                    component={Link}
                    to={"/admin/subcategory_tier_two/update/" + props.id}
                    variant="contained"
                    size="small"
                    type="button"
                >
                ...
                <React.Fragment>
                    ...
                    >
                        ...
                        <DialogContent>
                            <DialogContentText>
                                Do you want to delete {props.subcategoryTierTwo.name} subcategory tier two?
                            </DialogContentText>
                        </DialogContent>
                        <DialogActions>
                            <CancelButton
...
export default SubcategoryTierTwoItem;