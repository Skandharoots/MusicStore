...
import SubcategoryTierTwoItem from "./components/SubcategoryTierTwoItem.jsx";
...
function SubcategoryTierTwo() {
    const [subcategories, setSubcategories] = useState([]);
    const [openBackdrop, setOpenBackdrop] = useState(false);
    const navigate = useNavigate();

    useEffect(() => {
        document.title = 'Subcategory tier two management';
    }, []);

    const redirect = () => {
        navigate('/admin/subcategory_tier_two/add');
    }
    ...
    useEffect(() => {
        ...
        axios.get('api/products/subcategory_tier_two/get', {})
            .then(res => {
    ...
    return (
        <SubcategoryContainer>
            ...
            <PageTitle>
                <Typography variant="h5">Subcategories tier two</Typography>
            </PageTitle>
            ...
            <SubcategoriesGrid container rowSpacing={2.7} columnSpacing={2.7}>
                {subcategories.map((subcategoryTierTwo) => (
                    <SubcategoryTierTwoItem
                        key={subcategoryTierTwo.id}
...
export default SubcategoryTierTwo;