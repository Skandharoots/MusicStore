...
public class JwtServiceTests {
        ...
        private Long expTime = 6273837L;

        private Long refExpTime = 78293839289L;
        ...
        public void getUsernameTest() {
                ...
                when(variablesConfiguration.getExpiration())
                                .thenReturn(expTime);
        ...
        public void generateRefreshTokenTest() {
                ...
                when(variablesConfiguration.getRefreshExpiration())
                                .thenReturn(refExpTime);

                String refToken = jwtService.generateRefreshToken(user);
                Assertions.assertThat(jwtService.validateToken(refToken, user)).isTrue();
                Assertions.assertThat(jwtService.validateToken(refToken, userFail)).isFalse();
