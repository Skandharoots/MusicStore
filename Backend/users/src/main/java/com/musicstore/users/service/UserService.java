...
public class UserService implements UserDetailsService {
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;"
                ...
                + "        \n"
                + "        <table role=\"presentation\" width=\"100%\" style=\"border"
                + "-collapse:collapse;"
                + "max-width:580px\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" "
                + "align=\"center\">\n"
                + "          <tbody><tr>\n" + "            <td width=\"70\" bgcolor=\"#0b0c0c"
                + "\" valign=\"middle\">\n"
                ...
                + "sans-serif;font-weight:700;color:#ffffff;text-decoration:none;"
                ...
                + "align=\"center\" "
                + "cellpadding=\"0\" cellspacing=\"0\" border=\"0\" style=\""
                ...
                + "your account: </p><blockquote style="
                ...
                + "line-height:25px;"
                + "olor:#0b0c0c\"> <a href=\"" + link + "\">Activate Now</a> </p></blockquote>"
                + "\n Link will expire in 20 minutes. "
                + "<p>See you soon</p>" + "        \n" + "      </td>\n"
                + "      <td width=\"10\" valign=\"middle\"><br></td>\n"
                + "    </tr>\n" + "    <tr>\n" + "      <td height=\"30\"><br></td>\n"
                + "    </tr>\n" + "  </tbody></table><div class=\"yj6qo\"></div><div "
                + "class=\"adL\">\n" + "\n" + "</div></div>";
    }
}
