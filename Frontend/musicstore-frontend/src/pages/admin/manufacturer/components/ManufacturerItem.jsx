...
const ManufacturerItemContainer = styled(Grid)(({theme}) => ({
    display: 'flex',
    flexDirection: 'row',
    width: '240px',
    height: '70px',
...
const ManufacturerMetrics = styled(Box)(({theme}) => ({
    width: '60%',
    display: 'flex',
...
const ManufacturerButtons = styled(Box)(({theme}) => ({
    height: '100%',
    marginRight: 0,
    display: 'flex',
    flexDirection: 'column',
...
function ManufacturerItem(props) {
    ...
    return (
        <ManufacturerItemContainer key={props.id}>
            <Backdrop
            ...
            <ManufacturerButtons>
                ...
                <Dialog open={open} onClose={handleClose}>
                    ...
                    <DialogActions>
                        ...
                        <ConfirmDeleteButton variant="contained" onClick={deleteManufacturer}>
                            Delete
                        </ConfirmDeleteButton>
                    </DialogActions>
                </Dialog>
            </ManufacturerButtons>
        </ManufacturerItemContainer>
    );
}
