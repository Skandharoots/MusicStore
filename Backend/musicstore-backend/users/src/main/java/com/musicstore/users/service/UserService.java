...
public class UserService implements UserDetailsService {
    ...
    private String buildEmail(String name, String link) {
        return "<!DOCTYPE html>\n" +
                ...
                "                                                    <div style=\"max-width: 500px;\"><img src=\"https://78e5c3ac46.imgdist.com/pub/bfra/42gk87sq/109/wqo/qg0/logo.svg\" style=\"display: block; height: auto; border: 0; width: 100%;\" width=\"500\" alt title height=\"auto\"></div>\n" +
                "                                                </div>\n" +
                "                                            </td>\n" +
                "                                        </tr>\n" +
                "                                    </table>\n" +
                ...
                "                                        <tr>\n" +
                "                                            <td class=\"pad\">\n" +
                "                                                <h1 style=\"margin: 0; color: #1e0e4b; direction: ltr; font-family: Arial, 'Helvetica Neue', Helvetica, sans-serif; font-size: 38px; font-weight: 400; letter-spacing: normal; line-height: 120%; text-align: left; margin-top: 0; margin-bottom: 0; mso-line-height-alt: 45.6px;\"><em>Welcome, " + name + "!</em></h1>\n" +
                "                                            </td>\n" +
                "                                        </tr>\n" +
                "                                    </table>\n" +
                "                                </td>\n" +
                ...
                "                                                    <v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"" + link + "\" style=\"height:56px;width:480px;v-text-anchor:middle;\" arcsize=\"8%\" stroke=\"false\" fillcolor=\"#276318\">\n" +
                "                                                        <w:anchorlock/>\n" +
                "                                                        <v:textbox inset=\"0px,0px,0px,0px\">\n" +
                "                                                            <center dir=\"false\" style=\"color:#ffffff;font-family:Arial, sans-serif;font-size:23px\">\n" +
                "                                                    <![endif]--><a href=\"" + link + "\" target=\"_blank\" style=\"background-color:#276318;border-bottom:0px solid transparent;border-left:0px solid transparent;border-radius:4px;border-right:0px solid transparent;border-top:0px solid transparent;color:#ffffff;display:block;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:23px;font-weight:400;mso-border-alt:none;padding-bottom:5px;padding-top:5px;text-align:center;text-decoration:none;width:100%;word-break:keep-all;\"><span style=\"word-break: break-word; padding-left: 20px; padding-right: 20px; font-size: 23px; display: inline-block; letter-spacing: normal;\"><span style=\"word-break: break-word; line-height: 46px;\">Activate</span></span></a><!--[if mso]></center></v:textbox></v:roundrect><![endif]--></div>\n" +
                "                                            </td>\n" +
                "                                        </tr>\n" +
                "                                    </table>\n" +
                "                                </td>\n" +
